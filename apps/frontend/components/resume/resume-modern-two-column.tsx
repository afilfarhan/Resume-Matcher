...
export const ResumeModernTwoColumn: React.FC<ResumeModernTwoColumnProps> = ({
  ...
  console.log('[ResumeModernTwoColumn] languages:', languages);
  console.log('[ResumeModernTwoColumn] certificationsTraining:', certificationsTraining);
  console.log('[ResumeModernTwoColumn] awards:', awards);
